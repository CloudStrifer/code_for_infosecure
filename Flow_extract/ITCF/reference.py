    ...
    def __init__(self, data_root):
        ...
        for traffic in os.listdir(data_root):
            ...
            if traffic.endswith('.pcap'):
                ...
                if flag != 0:
                    #np.savez(os.path.join(cw d +BASE_PATH, filenam e +'.npz'), data=self.data, label=self.label)
                    # np.savez('E:/下载/论文下载的资料/pytorch-pcap-cnn-main/pytorch-pcap-cnn-main/pre/facebook_video1a.npz',
